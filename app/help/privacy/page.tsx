    ...
    return (
        <div className="min-h-screen bg-[#FDF2EC] font-[Outfit] text-[#5B2D7D] pb-12">
            <header className="sticky top-0 z-30 bg-[#FDF2EC]/80 backdrop-blur-xl border-b border-[#5B2D7D]/5 px-6 py-4 flex items-center gap-4">
                ...
                <h1 className="text-xl font-black text-[#5B2D7D] uppercase tracking-tight">Privacy Policy</h1>
            </header>

            <main className="px-6 py-8 max-w-2xl mx-auto space-y-8">
                <section className="space-y-4">
                    <h2 className="text-[#3E1C56] text-2xl font-bold">Data Collection</h2>
                    <p className="text-[#5B2D7D]/80 leading-relaxed">
                ...
                <section className="space-y-4">
                    <h2 className="text-[#3E1C56] text-2xl font-bold">How We Use Data</h2>
                    <ul className="list-disc list-inside text-[#5B2D7D]/80 space-y-2">
                ...
                <section className="space-y-4">
                    <h2 className="text-[#3E1C56] text-2xl font-bold">Data Security</h2>
                    <p className="text-[#5B2D7D]/80 leading-relaxed">
                ...
                <section className="space-y-4">
                    <h2 className="text-[#3E1C56] text-2xl font-bold">Your Rights</h2>
                    <p className="text-[#5B2D7D]/80 leading-relaxed">
                ...
                <section className="space-y-4">
                    <h2 className="text-[#3E1C56] text-2xl font-bold">Contact Us</h2>
                    <p className="text-[#5B2D7D]/80 leading-relaxed">
