    ...
    return (
        <div className="min-h-dvh bg-[#FDF2EC] flex flex-col font-[Outfit] relative overflow-hidden">
            ...
            <AnimatePresence>
                {isPending && (
                    ...
                    >
                        ...
                        <p className="text-[#5B2D7D]/60 max-w-[240px]">We&apos;re setting up your rituals. This will only take a moment.</p>
                    </motion.div>
                )}
            </AnimatePresence>
            ...
            <header className="px-6 pt-10 pb-6 text-center shrink-0 relative z-10">
                ...
                <h1 className="text-2xl font-bold text-[#5B2D7D] mb-1">Day-Night Medallion</h1>
                <p className="text-[#5B2D7D]/60 text-sm">Step {step} of 5</p>
            </header>
                ...
                <AnimatePresence mode="wait">
                        ...
                        >
                            <div className="bg-white/40 backdrop-blur-xl rounded-[32px] p-6 shadow-sm border border-white/50">
                                ...
                                <input
                                    ...
                                    className="w-full px-0 py-2 text-xl font-bold text-[#5B2D7D] bg-transparent border-b-2 border-[#5B2D7D]/10 outline-none focus:border-[#5B2D7D]/30 transition-colors"
                                />
                                <p className="mt-4 text-xs text-[#5B2D7D]/50 leading-relaxed">
                    ...
                    {step === 2 && (
                        ...
                        >
                            ...
                            <p className="text-sm text-[#5B2D7D]/60 mb-6">Choose a template or build your own custom stack (max 3 habits).</p>
                                    ...
                                    {morningHabits.map((h, i) => (
                                        <div key={i} className="bg-white/40 backdrop-blur-md p-4 rounded-2xl flex items-center justify-between border border-white/30 shadow-sm">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <h4 className="font-bold text-sm text-[#5B2D7D]">{h.title}</h4>
                                                    <p className="text-[10px] text-[#5B2D7D]/40">{h.duration}s • {h.description}</p>
                                                </div>
                                            </div>
                                            <button onClick={() => removeHabit(h.title, "MORNING")} className="text-[#5B2D7D]/20 hover:text-red-400">
                                                <X className="w-4 h-4" />
                                            </button>
                                        </div>
                                    ))}
                    ...
                    {step === 3 && (
                        ...
                        >
                            ...
                            <p className="text-sm text-[#5B2D7D]/60 mb-6">Set your evening wind-down routine (max 3 habits).</p>
                                ...
                                <div className="space-y-3">
                                    {nightHabits.map((h, i) => (
                                        <div key={i} className="bg-white/40 backdrop-blur-md p-4 rounded-2xl flex items-center justify-between border border-white/30 shadow-sm">
                                            ...
                                            <button onClick={() => removeHabit(h.title, "NIGHT")} className="text-[#5B2D7D]/20 hover:text-red-400">
                                                <X className="w-4 h-4" />
                                            </button>
                                        </div>
                                    ))}
                    ...
                    {step === 4 && (
                        ...
                        >
                            ...
                            <p className="text-sm text-[#5B2D7D]/60 mb-6">Add any other habits you want to track throughout the day.</p>
                                ...
                                {otherHabits.map((h, i) => (
                                    <div key={i} className="bg-white/40 backdrop-blur-md p-4 rounded-2xl flex items-center justify-between border border-white/30 shadow-sm">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <h4 className="font-bold text-sm text-[#5B2D7D]">{h.title}</h4>
                                                <p className="text-[10px] text-[#5B2D7D]/40">{h.description}</p>
                                            </div>
                                        </div>
                                        <button onClick={() => removeHabit(h.title, "OTHER")} className="text-[#5B2D7D]/20 hover:text-red-400">
                    ...
                    {step === 5 && (
                        ...
                        >
                            <div className="bg-white/40 backdrop-blur-xl rounded-[40px] p-8 shadow-sm border border-white/50 text-center">
                                ...
                                <p className="text-sm text-[#5B2D7D]/60 mb-8">Your medallion is configured with {selectedHabits.length} habits across your rituals.</p>
                                
                                <div className="space-y-4 text-left">
                                    <div className="flex items-center justify-between text-xs">
                                        <span className="text-[#5B2D7D]/40 font-bold uppercase tracking-widest">Morning Ritual</span>
                                        <span className="font-bold text-[#5B2D7D]">{morningHabits.length} habits</span>
                                    </div>
                                    <div className="flex items-center justify-between text-xs">
                                        <span className="text-[#5B2D7D]/40 font-bold uppercase tracking-widest">Night Ritual</span>
                                        <span className="font-bold text-[#5B2D7D]">{nightHabits.length} habits</span>
                                    </div>
                                    <div className="flex items-center justify-between text-xs">
                                        <span className="text-[#5B2D7D]/40 font-bold uppercase tracking-widest">Other Habits</span>
                                        <span className="font-bold text-[#5B2D7D]">{otherHabits.length} habits</span>
                                    </div>
                                </div>
                            </div>
                        </motion.div>
            ...
            <div className="fixed bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-[#FDF2EC] via-[#FDF2EC] to-transparent z-40">
                <div className="flex gap-3 max-w-md mx-auto">
                    ...
                    {step < 5 ? (
                        <button
                            onClick={() => setStep(s => s + 1)}
                            className="flex-1 h-14 rounded-2xl bg-[#5B2D7D] text-white font-bold shadow-lg shadow-[#5B2D7D]/20 flex items-center justify-center gap-2 active:scale-[0.98] transition-all"
                        >
                        ...
                        <button
                            ...
                            disabled={isPending}
                            className="flex-1 h-14 rounded-2xl bg-[#5B2D7D] text-white font-bold shadow-lg shadow-[#5B2D7D]/20 flex items-center justify-center gap-2 active:scale-[0.98] transition-all disabled:opacity-50"
                        >
                            ...
                            {!isCustom ? (
                                        ...
                                        <div key={cat.id} className="bg-white/40 backdrop-blur-md rounded-3xl overflow-hidden border border-white/30 shadow-sm">
                                            ...
                                            >
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <span className="font-bold text-[#5B2D7D]">{cat.title}</span>
                                                </div>
                                                {expandedCat === cat.id ? <ChevronUp className="w-4 h-4 text-[#5B2D7D]/30" /> : <ChevronDown className="w-4 h-4 text-[#5B2D7D]/30" />}
                                            </button>
                                ...
                                <div className="space-y-6">
                                    <div className="space-y-4">
                                        <div>
                                            <label className="text-[10px] font-black text-[#5B2D7D]/30 uppercase tracking-widest block mb-2 ml-1">Habit Name</label>
                                            <input 
                                                type="text" 
                                                value={customTitle}
                                        ...
                                        {ritualType !== "OTHER" && (
                                            <div>
                                                <label className="text-[10px] font-black text-[#5B2D7D]/30 uppercase tracking-widest block mb-2 ml-1">Duration (Seconds)</label>
                                                <input 
                                                    type="number" 
                                    ...
                                    <div className="flex gap-3">
                                        ...
                                        <button 
                                            ...
                                            className="flex-[2] h-14 rounded-2xl bg-[#5B2D7D] text-white font-bold text-sm shadow-lg shadow-[#5B2D7D]/20"
                                        >
                                            Add Custom
                                        </button>
                                    </div>
