...
export default function Loading() {
  return (
    <div className="flex h-dvh w-full flex-col items-center justify-center bg-[#FDF2EC]">
      <div className="flex flex-col items-center gap-6">
        ...
        <div className="text-center">
            <h2 className="text-xl font-bold text-[#5B2D7D] mb-1">Checking Your Rituals</h2>
            <p className="text-xs text-[#5B2D7D]/40 uppercase font-black tracking-widest">Just a moment...</p>
        </div>
      </div>
    </div>
  );
